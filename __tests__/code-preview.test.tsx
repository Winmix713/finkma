...
describe("CodePreview", () => {
  ...
  describe("Rendering", () => {
    ...
    test("renders with custom component name", () => {
      render(
        <CodePreview content={mockContent} componentName="CustomButton" />,
      );
    ...
    test("shows empty state when no content provided", () => {
      ...
      expect(
        screen.getByText(/no code content available/i),
      ).toBeInTheDocument();
    });
    ...
    test("hides empty tabs", () => {
      ...
      expect(screen.getByRole("tab", { name: /jsx/i })).toBeInTheDocument();
      expect(
        screen.queryByRole("tab", { name: /css/i }),
  ...
  describe("Theme Support", () => {
    test("applies light theme by default", () => {
      ...
      const container =
        screen.getByTestId("code-preview") ||
  ...
  describe("Performance", () => {
    ...
    test("lazy loads syntax highlighter", async () => {
      ...
      expect(
        screen.getByText(/loading syntax highlighter/i),
      ).toBeInTheDocument();

      // Should load the actual highlighter
      await waitFor(() => {
        expect(
          screen.queryByText(/loading syntax highlighter/i),
        ).not.toBeInTheDocument();
      });
    });
  });
