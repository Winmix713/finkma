  ...
  const dangerousPatterns = [
    {
      ...
      message: "dangerouslySetInnerHTML detected - potential XSS risk",
    },
    ...
    },
    {
      ...
      message: "javascript: protocol detected - security risk",
    },
    {
      pattern: /<script/gi,
      message: "Script tag detected - potential security risk",
    },
  ];
...
export function validateCSS(code: string): ValidationResult {
  ...
  if (code.includes("!important")) {
    result.warnings.push({
      message:
        "!important usage detected - consider refactoring for better specificity",
      severity: "warning",
    });
  }
