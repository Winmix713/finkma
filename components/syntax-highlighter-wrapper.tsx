...
const SyntaxHighlighterWrapperComponent = memo<SyntaxHighlighterWrapperProps>(
  ({ code, language, theme, showLineNumbers = true, maxHeight = "400px", className = "", wrapLines = true }) => {
        ...
        <Suspense
          fallback={
            <div className="flex items-center justify-center h-32 bg-gray-50 dark:bg-gray-800">
              ...
              <span className="ml-2 text-sm text-gray-600 dark:text-gray-400">Loading syntax highlighter...</span>
            </div>
          }
        >
          <SyntaxHighlighter
