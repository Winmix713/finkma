...
export function ConfigurationPanel({ options, onOptionsChange }: ConfigurationPanelProps) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value: CodeGenerationOptions["framework"]) => updateOption("framework", value)}
        >
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value: CodeGenerationOptions["styling"]) => updateOption("styling", value)}
        >
